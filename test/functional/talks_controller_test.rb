...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { description: @talk.description, end_date: @talk.end_date, start_date: @talk.start_date, status: @talk.status, title: @talk.title }
    end
  ...
  test "should update talk" do
    put :update, id: @talk, talk: { description: @talk.description, end_date: @talk.end_date, start_date: @talk.start_date, status: @talk.status, title: @talk.title }
    assert_redirected_to talk_path(assigns(:talk))
  end
